...
class Config:
    ...
    #
    # Example: At reference, odds = 100:1 (1% default rate)
    ...
    ODDS_AT_REFERENCE = 100    # Odds ratio at reference (good:bad = 100:1)
...
class CreditScoringPipeline:
    ...
    def train(self):
        ...
        good_threshold = score_to_probability(Config.GOOD_SCORE_THRESHOLD)      # Score 180 -> prob ~0.22
        not_good_threshold = score_to_probability(Config.NOT_GOOD_SCORE_THRESHOLD)  # Score 200 -> prob ~0.15
